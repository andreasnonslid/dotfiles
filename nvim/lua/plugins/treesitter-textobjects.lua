return {
  {
    ...
    build = function()
      require("nvim-treesitter.install").install({
        "lua", "python", "c", "cpp", "vim", "vimdoc", "markdown", "markdown_inline", "bash",
      }):wait(300000)
    end,
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set({ "n", "x", "o" }, "[a", function() move.goto_previous_start("@parameter.inner") end, { desc = "Prev argument" })
